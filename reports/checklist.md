...
The report generated by using one of the inference runs as current data can be found on [this html](figures/data_drift_report.html).
...
Some of the most significant struggles in this project was the steep learning curve associated with the Google Cloud Platform (GCP), not making architectural decisions early on and the ripple of effect of implementing new integrations.
